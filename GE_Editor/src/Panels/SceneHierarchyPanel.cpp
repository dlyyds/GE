...
void DrawComponent(const char *name, Entity entity, UIFunction uiFunction) {
...
void SceneHierarchyPanel::DrawComponents(Entity entity) {
    ...
    if (ImGui::BeginPopup("AddComponent")) {
        if (ImGui::MenuItem("Camera")) {
            if (!m_SelectionContext.HasComponent<CameraComponent>())
                ...
                GE_CORE_WARN("This entity already has the Camera Component!");
        ...
        if (ImGui::MenuItem("Sprite Renderer")) {
            if (!m_SelectionContext.HasComponent<SpriteRendererComponent>())
                ...
                GE_CORE_WARN("This entity already has the Sprite Renderer Component!");
            ImGui::CloseCurrentPopup();
        }
    ...
    DrawComponent<TransformComponent>("Transform", entity, [](auto &component) {
        ...
        DrawVec3Control("Rotation", rotation, 0.0f, 120);
