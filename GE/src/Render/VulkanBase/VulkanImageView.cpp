...
VulkanImageView::VulkanImageView(VulkanImage &img,
                                 ...
                                 uint32_t n_array_layers) : VulkanResourceBase<vk::ImageView>{nullptr, &img.GetDevice()},
                                                            image{&img},
                                                            format{format} {
...
VulkanImageView::VulkanImageView(VulkanImageView &&other) : VulkanResourceBase<vk::ImageView>{std::move(other)},
                                                            image{other.image},
                                                            format{other.format},
