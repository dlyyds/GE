...
VulkanBufferBuilder::VulkanBufferBuilder(vk::DeviceSize size) :
    Parent(vk::BufferCreateInfo{.size = size})
{
}
...
VulkanBuffer::VulkanBuffer(VulkanDevice &device, VulkanBufferBuilder const &builder) :
    allocated::Allocated<vk::Buffer>{builder.get_allocation_create_info(), &device},
