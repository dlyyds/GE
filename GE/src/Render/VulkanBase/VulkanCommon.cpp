...
int32_t get_bits_per_pixel(VkFormat format) {
    ...
    case VK_FORMAT_R16G16_SFLOAT: return 32;
...
vk::AccessFlags getAccessFlags(vk::ImageLayout layout) {
    ...
    case vk::ImageLayout::eDepthAttachmentOptimal: return vk::AccessFlagBits::eDepthStencilAttachmentRead |
                                                          vk::AccessFlagBits::eDepthStencilAttachmentWrite;
    case vk::ImageLayout::eFragmentShadingRateAttachmentOptimalKHR: return vk::AccessFlagBits::eFragmentShadingRateAttachmentReadKHR;
    case vk::ImageLayout::eShaderReadOnlyOptimal: return vk::AccessFlagBits::eShaderRead | vk::AccessFlagBits::eInputAttachmentRead;
...
vk::PipelineStageFlags getPipelineStageFlags(vk::ImageLayout layout) {
    ...
    case vk::ImageLayout::eFragmentShadingRateAttachmentOptimalKHR: return vk::PipelineStageFlagBits::eFragmentShadingRateAttachmentKHR;
    case vk::ImageLayout::eShaderReadOnlyOptimal: return vk::PipelineStageFlagBits::eVertexShader | vk::PipelineStageFlagBits::eFragmentShader;
...
void image_layout_transition(vk::CommandBuffer command_buffer,
    ...
    image_layout_transition(command_buffer, image, src_stage_mask, dst_stage_mask, src_access_mask, dst_access_mask, old_layout, new_layout,
                            subresource_range);
}
...
uint32_t get_queue_family_index(std::vector<vk::QueueFamilyProperties> const &queue_family_properties, vk::QueueFlagBits queue_flag) {
    ...
    auto propertyIt = std::ranges::find_if(
        queue_family_properties, [queue_flag](const vk::QueueFamilyProperties &property) {
